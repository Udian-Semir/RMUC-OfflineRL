...
from sentry_tactical_rl.env import EFFECTIVE_DPS_ROLES, REFEREE_ROLE_NAMES, Unit
...
def frame(map_obj: SemanticMap, battlefield: Image.Image, hp_state: dict[str, float], units: list[Unit], commands: dict[int, Any], events: tuple[dict[str, Any], ...], sentry_state: dict[str, float], step: int, profile: str, *, title: str, detail: str) -> Image.Image:
