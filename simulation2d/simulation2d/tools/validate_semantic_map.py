...
Example::
    ...
    ros2 run simulation2d simulation2d_validate_map
...
def main() -> None:
    ...
    parser.add_argument("--annotation", default=str(asset_path("demo_map.png")))
    parser.add_argument("--obstacle", default=str(asset_path("blackwhite_map.png")))
    parser.add_argument("--json", dest="json_path", default=str(asset_path("semantic_map_aligned.json")))
    parser.add_argument("--diagnostic", default="semantic_map_debug.png")
    parser.add_argument("--report", default="semantic_map_validation.json")
