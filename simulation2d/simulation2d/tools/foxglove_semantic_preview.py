...
Run after building the Radar-Station workspace and sourcing ROS 2 Humble::
...
from ..visualization.semantic_preview import SemanticPreview, load_semantic_preview
...
class SemanticPreviewNode(Node):
    def __init__(self, preview: SemanticPreview, *, frame_id: str, parent_frame: str,
        ...
        super().__init__("simulation2d_semantic_preview")
...
def main() -> None:
    parser = argparse.ArgumentParser(description="Publish the simulation2d semantic map to Foxglove via ROS 2")
    parser.add_argument("--json", default=str(asset_path("semantic_map_aligned.json")))
