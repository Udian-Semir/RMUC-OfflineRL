...
def main():
    ...
    ap.add_argument("--annotation", default=str(asset_path("demo_map.png")))
    ap.add_argument("--obstacle", default=str(asset_path("blackwhite_map.png")))
    ap.add_argument("--out-image", default="semantic_map_aligned.png")
    ap.add_argument("--out-json", default="semantic_map_aligned.json")
