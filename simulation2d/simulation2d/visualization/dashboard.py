...
class TrainingDashboard:
    ...
    def _render(self) -> None:
        ...
        axes[2].plot(x, series("mean_blue_base_damage"), label="blue base")
        axes[2].plot(x, series("mean_red_base_damage"), label="red base loss")
        axes[2].plot(x, series("mean_healing"), label="sentry healing")
